...
namespace DVLD_Business
{
    public class clsLicenseClass
    {
        ...
        public clsLicenseClass(int LicenseClassID, string ClassName, string ClassDescription, short MinimumAllowedAge, 
        ...
        public static clsLicenseClass Find(int LicenseClassID)
        {
            ...
            if (clsLicenseClassData.GetLicenseClassInfoByLicenseClassID(LicenseClassID, ref ClassName, ref ClassDescription, ref MinimumAllowedAge, ref DefaultValidityLength, ref ClassFees))
            {
        ...
        public static clsLicenseClass Find(string ClassName)
        {
            ...
            if (clsLicenseClassData.GetLicenseClassInfoByLicenseClassName(ClassName, ref LicenseClassID, ref ClassDescription, ref MinimumAllowedAge, ref DefaultValidityLength, ref ClassFees))
            {
                return new clsLicenseClass(LicenseClassID, ClassName, ClassDescription, MinimumAllowedAge,
                    DefaultValidityLength, ClassFees);
            }
