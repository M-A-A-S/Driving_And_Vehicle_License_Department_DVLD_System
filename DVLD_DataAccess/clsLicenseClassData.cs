...
namespace DVLD_DataAccess
{
    ...
    {
        public static bool GetLicenseClassInfoByLicenseClassID(int LicenseClassID, 
        ...
        public static bool GetLicenseClassInfoByLicenseClassName(string ClassName, ref int LicenseClassID, 
        ...
        public static bool UpdateLicenseClass(int LicenseClassID, string ClassName, 
            string ClassDescription, short MinimumAllowedAge, short DefaultValidityLength, float ClassFees)
        {
            int rowsAffected = 0;
